...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # hi += there  =>  hi = hi + there    the variable will point to a new object
    # but hi << there		will modify hi and original_string because there two
    # variables point to same String object.
  end
